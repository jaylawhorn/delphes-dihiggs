...
void draw_em(std::string var="mTT",int nbins=10, double xmin=0, double xmax=200,std::string xtitle="m_{#tau#tau}", std::string ytitle="Events")
{
  ...
  std::string ththcut = jetcut+"*( ( (tauCat1==3 && tauCat2==2) || (tauCat2==3 && tauCat1==2) ) && mJJ>500 && abs(dEta)>3.5)";
  ...
  const char* category = "";
  CMSPrelim(dataset, "e#mu", 0.17, 0.835);
