...
void draw_mt(std::string var="mTT",int nbins=10, double xmin=0, double xmax=200,std::string xtitle="m_{#tau#tau}", std::string ytitle="Events")
{
  ...
  std::string ththcut = jetcut+"*( ( (tauCat1==1 && tauCat2==3) || (tauCat2==1 && tauCat1==3) ) && mJJ>500 && abs(dEta)>3.5)";
