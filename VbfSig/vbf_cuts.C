...
void vbf_cuts(const TString conf="new.conf", Int_t tauType=0) {
  ...
  if (tauType==0) { 
    cout << "all" << endl;
    CPlot::sOutDir = "vbf_all";     
  }
  else if (tauType==1) {
    cout << "dijet45" << endl;
    CPlot::sOutDir = "vbf_dijet45"; 
  }
  else if (tauType==2) {
    cout << "jet-mu" << endl;
    CPlot::sOutDir = "vbf_jetmu"; 
  }
  else if (tauType==3) {
    cout << "jet-ele" << endl;
      CPlot::sOutDir = "vbf_jetele"; 
  }
  else if (tauType==4) {
    cout << "mu-ele" << endl;
    CPlot::sOutDir = "vbf_muele"; 
  }
  else if (tauType==5) {
    cout << "dijet30" << endl;
    CPlot::sOutDir = "vbf_dijet30"; 
  }
  ...
  vector<Double_t> tautauCutsXsecUnc;
  ...
  for(UInt_t isam=0; isam<processType.size(); isam++) {
    ...
    preselectXsecUnc.push_back(0); kineCutsXsecUnc.push_back(0); tautauCutsXsecUnc.push_back(0); 
  ...
  cout << "sample\t\t presel\t tau/b\t bb\t hh\t mt2" << endl;

  for (UInt_t i=0; i<processType.size(); i++) {

    cout << processType[i] << "\t" << totalXsec[i]*3000 << " \\pm "  << TMath::Sqrt(totalXsec[i])*3000 << "\t";
    cout << kineCutsXsec[i]*3000 << " \\pm " << TMath::Sqrt(kineCutsXsecUnc[i])*3000 << "\t";
    cout << tautauCutsXsec[i]*3000 << " \\pm " << TMath::Sqrt(tautauCutsXsecUnc[i])*3000 << "\n";
