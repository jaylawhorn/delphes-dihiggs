...
void bbtt_upg_mt(std::string var,int nbins, double xmin, double xmax,std::string xtitle, std::string ytitle, double sigscale=1)
{
  ...
  std::string objcut = "(tauCat1==1 && tauCat2==3 && ptTau1>30 && ptTau2>20 && tauIso2<0.4 && (bTag1==2||bTag1==3||bTag1==6||bTag1==7) && (bTag2==1||bTag2==3||bTag2==6||bTag2==7) && ptB1>20 && ptB2>20 && sqrt( (etaTau1-etaTau2)**2 + (phiTau1-phiTau2)**2 )>0.4)";
  std::string jetcut = objcut;//+"*(mTT>40 && mTT<100)*(mBB1>70 && mBB1<140)";
  //signal region
