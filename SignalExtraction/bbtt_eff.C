...
void bbtt_test(std::string var="bdtVal",int nbins=20, double xmin=-0.5, double xmax=0.5,std::string xtitle="", std::string ytitle="", double sigscale=1,int hist=1)
{
  ...
  double eff_points[10] = { 0.2, 0.3, 0.4, 0.45, 0.5, 0.55, 0.6, 0.65, 0.7, 0.8 };
  ...
  for (Int_t i=0; i<10; i++) {
    ...
    //cout << scaleR << endl;
    sigrealcut=jetcut+realcut+"*"+scaleRstr.str()+"*eventWeight*"+lumi.str();
