...
void newSelect(const TString inputfile="root://eoscms.cern.ch//store/group/phys_higgs/upgrade/PhaseII/Configuration4v2/140PileUp/HHToTTBB_14TeV/HHToTTBB_14TeV_1.root", 
  ...
  for (Int_t iEntry=0; iEntry<numberOfEntries; iEntry++) { // entry loop
    ...
    /*
    cout << "  new event: " << endl;
    cout << "leading jet " << leadingJet->PT << endl;
    if (iB1!=-1) cout << "B jet 1 " << jetB1->PT << endl;
    if (iB2!=-1) cout << "B jet 2 " << jetB2->PT << endl;
    if (iT1!=-1) {
      if (tauCat1==hadron) cout << "T jet 1 " << jetTau1->PT << endl;
      if (tauCat1==muon) cout << "T muo 1 " << muTau->PT << endl;
      if (tauCat1==electron) cout << "T ele 1 " << eleTau->PT << endl;
    }
    if (iT2!=-1) {
      if (tauCat2==hadron) cout << "T jet 2 " << jetTau2->PT << endl;
      if (tauCat2==muon) cout << "T muo 2 " << muTau->PT << endl;
      if (tauCat2==electron) cout << "T ele 2 " << eleTau->PT << endl;
    }
    if (iE!=-1) cout << "extra jet " << extraJet->PT << endl;
    */
