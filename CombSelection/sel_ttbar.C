...
void sel_ttbar(const TString inputfile="root://eoscms.cern.ch//store/group/upgrade/delphes/PhaseII_140PU_ProdJul28/tt-4p-0-600-v1510_14TEV/tt-4p-0-600-v1510_14TEV_215803259_PhaseII_Conf4_140PileUp_seed215803264_5of5.root",
	       const Float_t xsec=1.0,
	       Int_t sampleNo=100,
	       const TString outputfile="test1.root") {
  ...
  Float_t ptB1_genJet, ptB2_genJet, etaB1_genJet, etaB2_genJet, phiB1_genJet, phiB2_genJet, mB1_genJet, mB2_genJet;
  Float_t ptB3_genJet, ptB4_genJet, etaB3_genJet, etaB4_genJet, phiB3_genJet, phiB4_genJet, mB3_genJet, mB4_genJet;
  ...
  outTree->Branch("ptB1_genJet",  &ptB1_genJet,  "ptB1_genJet/f");    // gen pt(B1)
  outTree->Branch("etaB1_genJet", &etaB1_genJet, "etaB1_genJet/f");   // gen eta(B1)
  outTree->Branch("phiB1_genJet", &phiB1_genJet, "phiB1_genJet/f");   // gen phi(B1)
  outTree->Branch("mB1_genJet",   &mB1_genJet,   "mB1_genJet/f");     // gen m(B1)

  outTree->Branch("ptB2_genJet",  &ptB2_genJet,  "ptB2_genJet/f");    // gen pt(B2)
  outTree->Branch("etaB2_genJet", &etaB2_genJet, "etaB2_genJet/f");   // gen eta(B2)
  outTree->Branch("phiB2_genJet", &phiB2_genJet, "phiB2_genJet/f");   // gen phi(B2)
  outTree->Branch("mB2_genJet",   &mB2_genJet,   "mB2_genJet/f");     // gen m(B2)

  outTree->Branch("ptB3_genJet",  &ptB3_genJet,  "ptB3_genJet/f");    // gen pt(B3)
  outTree->Branch("etaB3_genJet", &etaB3_genJet, "etaB3_genJet/f");   // gen eta(B3)
  outTree->Branch("phiB3_genJet", &phiB3_genJet, "phiB3_genJet/f");   // gen phi(B3)
  outTree->Branch("mB3_genJet",   &mB3_genJet,   "mB3_genJet/f");     // gen m(B3)

  outTree->Branch("ptB4_genJet",  &ptB4_genJet,  "ptB4_genJet/f");    // gen pt(B4)
  outTree->Branch("etaB4_genJet", &etaB4_genJet, "etaB4_genJet/f");   // gen eta(B4)
  outTree->Branch("phiB4_genJet", &phiB4_genJet, "phiB4_genJet/f");   // gen phi(B4)
  outTree->Branch("mB4_genJet",   &mB4_genJet,   "mB4_genJet/f");     // gen m(B4)
  ...
  outTree->Branch("ptJet_tt1_gen",  &ptJet_tt1_gen,  "ptJet_tt1_gen/f");    // gen jet pt(Jet1) (bjet)
  outTree->Branch("etaJet_tt1_gen", &etaJet_tt1_gen, "etaJet_tt1_gen/f");   // gen jet eta(Jet1) (bjet)
  outTree->Branch("phiJet_tt1_gen", &phiJet_tt1_gen, "phiJet_tt1_gen/f");   // gen jet phi(Jet1) (bjet)
  outTree->Branch("mJet_tt1_gen",   &mJet_tt1_gen,   "mJet_tt1_gen/f");     // gen jet m(Jet1) (bjet)

  outTree->Branch("ptJet_tt2_gen",  &ptJet_tt2_gen,  "ptJet_tt2_gen/f");    // gen jet pt(Jet_tt2) (bjet)
  outTree->Branch("etaJet_tt2_gen", &etaJet_tt2_gen, "etaJet_tt2_gen/f");   // gen jet eta(Jet_tt2) (bjet)
  outTree->Branch("phiJet_tt2_gen", &phiJet_tt2_gen, "phiJet_tt2_gen/f");   // gen jet phi(Jet_tt2) (bjet)
  outTree->Branch("mJet_tt2_gen",   &mJet_tt2_gen,   "mJet_tt2_gen/f");     // gen jet m(Jet_tt2) (bjet)
  ...
  //for (Int_t iEntry=400; iEntry<450; iEntry++) { // entry loop
    ...
    ptB1_genJet=-999; etaB1_genJet=-999; phiB1_genJet=-999; mB1_genJet=-999;
    ptB2_genJet=-999; etaB2_genJet=-999; phiB2_genJet=-999; mB2_genJet=-999;
    ptB3_genJet=-999; etaB3_genJet=-999; phiB3_genJet=-999; mB3_genJet=-999;
    ptB4_genJet=-999; etaB4_genJet=-999; phiB4_genJet=-999; mB4_genJet=-999;
    ptJet_tt1_gen=-999; etaJet_tt1_gen=-999; phiJet_tt1_gen=-999; mJet_tt1_gen=-999;
    ptJet_tt2_gen=-999; etaJet_tt2_gen=-999; phiJet_tt2_gen=-999; mJet_tt2_gen=-999;
	...
	genB1 = (GenParticle*) branchParticle->At(iGenB1);
      ...
      else if (genParticle->PT>genB1->PT) {
	if (genB3) {
	  iGenB4=iGenB3;
	...
	genB2 = (GenParticle*) branchParticle->At(iGenB2);
      ...
      else if (genParticle->PT>genB2->PT) {
	if (genB3) {
	  iGenB4=iGenB3;
	  genB4 = (GenParticle*) branchParticle->At(iGenB4);
	}
	...
	genB3 = (GenParticle*) branchParticle->At(iGenB3);
      ...
      else if (genParticle->PT>genB3->PT) {
	if (genB3) {
	  iGenB4=iGenB3;
	  genB4 = (GenParticle*) branchParticle->At(iGenB4);
	}
	...
	genB4 = (GenParticle*) branchParticle->At(iGenB4);
      ...
      else if (genParticle->PT>genB4->PT) {
	iGenB4=iParticle;
	genB4 = (GenParticle*) branchParticle->At(iGenB4);
      }
    }
    ...
    for (Int_t iJet=0; iJet<branchGenJet->GetEntries(); iJet++) { // generator level jet loop
      ...
      if (!(genJetB1) && deltaR(genJet->Eta, etaB1_gen, genJet->Phi, phiB1_gen)<MAX_MATCH_DIST) {
	iGenJetB1=iJet;
	genJetB1 = (Jet*) branchGenJet->At(iGenJetB1);
      }
      else if ((genJetB1) && deltaR(genJet->Eta, etaB1_gen, genJet->Phi, phiB1_gen)<MAX_MATCH_DIST && genJet->PT>genJetB1->PT) {
	iGenJetB1=iJet;
	genJetB1 = (Jet*) branchGenJet->At(iGenJetB1);
      }
      else if (!(genJetB2) && deltaR(genJet->Eta, etaB2_gen, genJet->Phi, phiB2_gen)<MAX_MATCH_DIST) {
	iGenJetB2=iJet;
	genJetB2 = (Jet*) branchGenJet->At(iGenJetB2);
      }
      else if ((genJetB2) && deltaR(genJet->Eta, etaB2_gen, genJet->Phi, phiB2_gen)<MAX_MATCH_DIST && genJet->PT>genJetB2->PT) {
	iGenJetB2=iJet;
	genJetB2 = (Jet*) branchGenJet->At(iGenJetB2);
      }
      else if (!(genJetB3) && deltaR(genJet->Eta, etaB3_gen, genJet->Phi, phiB3_gen)<MAX_MATCH_DIST) {
	iGenJetB3=iJet;
	genJetB3 = (Jet*) branchGenJet->At(iGenJetB3);
      }
      else if ((genJetB3) && deltaR(genJet->Eta, etaB3_gen, genJet->Phi, phiB3_gen)<MAX_MATCH_DIST && genJet->PT>genJetB3->PT) {
	iGenJetB3=iJet;
	genJetB3 = (Jet*) branchGenJet->At(iGenJetB3);
      }
      else if (!(genJetB4) && deltaR(genJet->Eta, etaB4_gen, genJet->Phi, phiB4_gen)<MAX_MATCH_DIST) {
	iGenJetB4=iJet;
	genJetB4 = (Jet*) branchGenJet->At(iGenJetB4);
      }
      else if ((genJetB4) && deltaR(genJet->Eta, etaB4_gen, genJet->Phi, phiB4_gen)<MAX_MATCH_DIST && genJet->PT>genJetB4->PT) {
	iGenJetB4=iJet;
	genJetB4 = (Jet*) branchGenJet->At(iGenJetB4);
      }
    }
    ...
    if (genJetB1) {
      ptB1_genJet=genJetB1->PT;
      etaB1_genJet=genJetB1->Eta;
      phiB1_genJet=genJetB1->Phi;
      mB1_genJet=genJetB1->Mass;
    }

    if (genJetB2) {
      ptB2_genJet=genJetB2->PT;
      etaB2_genJet=genJetB2->Eta;
      phiB2_genJet=genJetB2->Phi;
      mB2_genJet=genJetB2->Mass;
    }

    if (genJetB3) {
      ptB3_genJet=genJetB3->PT;
      etaB3_genJet=genJetB3->Eta;
      phiB3_genJet=genJetB3->Phi;
      mB3_genJet=genJetB3->Mass;
    }

    if (genJetB4) {
      ptB4_genJet=genJetB4->PT;
      etaB4_genJet=genJetB4->Eta;
      phiB4_genJet=genJetB4->Phi;
      mB4_genJet=genJetB4->Mass;
    }
    ...
    for (Int_t iJet=0; iJet<branchJet->GetEntries(); iJet++) { // reconstructed jet loop
      ...
      Int_t match=0;
      if ( (genJetB1) && deltaR(jet->Eta, genJetB1->Eta, jet->Phi, genJetB1->Phi)< MAX_MATCH_DIST ) match++;
      if ( (genJetB2) && deltaR(jet->Eta, genJetB2->Eta, jet->Phi, genJetB2->Phi)< MAX_MATCH_DIST ) match++;
      if ( (genJetB3) && deltaR(jet->Eta, genJetB3->Eta, jet->Phi, genJetB3->Phi)< MAX_MATCH_DIST ) match++;
      if ( (genJetB4) && deltaR(jet->Eta, genJetB4->Eta, jet->Phi, genJetB4->Phi)< MAX_MATCH_DIST ) match++;
	...
	bTag1=jetB1->BTag;
      ...
      else if ( deltaR(jet->Eta, jetB1->Eta, jet->Phi, jetB1->Phi)<MAX_MATCH_DIST && (corr*jet->PT > jetB1->PT)) {
	iB1=iJet;
	jetB1 = (Jet*) branchJet->At(iB1);
      }
	...
	bTag2=jetB2->BTag;
      ...
      else if ( deltaR(jet->Eta, jetB2->Eta, jet->Phi, jetB2->Phi)<MAX_MATCH_DIST && (corr*jet->PT > jetB2->PT)) {
	iB2=iJet;
	jetB2 = (Jet*) branchJet->At(iB2);
      }
	...
	bTag3=jetB3->BTag;
      ...
      else if ( deltaR(jet->Eta, jetB3->Eta, jet->Phi, jetB3->Phi)<MAX_MATCH_DIST && (corr*jet->PT > jetB3->PT)) {
	iB3=iJet;
	jetB3 = (Jet*) branchJet->At(iB3);
      }
    ...
    for (Int_t iJet=0; iJet<branchJet->GetEntries(); iJet++) { // reconstructed jet loop
      ...
      else if (corr*jet->PT > jet_tt1->PT) { //doJetcorr(corrector,jet_tt1,rho_2,rho_1,rho_0)*jet_tt1->PT) {
        iJ2=iJ1;
      ...
      else if (corr*jet->PT > jet_tt2->PT) { //doJetcorr(corrector,jet_tt2,rho_2,rho_1,rho_0)*jet_tt2->PT) {
        iJ2=iJet;
        jet_tt2 = (Jet*) branchJet->At(iJ2);
        jbTag_tt2=jet_tt2->BTag;
      }
    ...
    for (Int_t iJet=0; iJet<branchJet->GetEntries(); iJet++) { // reconstructed jet loop
      ...
      else if (corr*jet->PT > jet_6j1->PT) {//doJetcorr(corrector,jet_6j1,rho_2,rho_1,rho_0)*jet_6j1->PT) {
	iJ4=iJ3;
	jet_6j2 = (Jet*) branchJet->At(iJ4);
      ...
      else if (corr*jet->PT > jet_6j2->PT) {//doJetcorr(corrector,jet_6j2,rho_2,rho_1,rho_0)*jet_6j2->PT) {
        iJ4=iJet;
        jet_6j2 = (Jet*) branchJet->At(iJ4);
        jbTag_6j2=jet_6j2->BTag;
      }
    ...
    if (jet_tt1) {
      double corrj1 = 1.0;//doJetcorr(corrector,jet_tt1,rho_2,rho_1,rho_0);
    ...
    if (jet_tt2) {
      double corrj2 = 1.0;//doJetcorr(corrector,jet_tt2,rho_2,rho_1,rho_0);
    ...
    if (jet_6j1) {
      double corrj1 = 1.0;//doJetcorr(corrector,jet_6j1,rho_2,rho_1,rho_0);
    ...
    if (jet_6j2) {
      double corrj2 = 1.0;//doJetcorr(corrector,jet_6j2,rho_2,rho_1,rho_0);
